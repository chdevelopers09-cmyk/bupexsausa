      ...
      >
        <div className="h-20 flex items-center px-6 border-b border-gray-100">
           <Link href="/" className="flex items-center gap-3 group">
            ...
            {isSidebarOpen && (
              <span className="font-black text-dark text-lg animate-fade-in truncate">BUPEXSA USA</span>
            )}
           </Link>
        </div>
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header className="h-20 bg-white border-b border-gray-100 px-8 flex items-center justify-between sticky top-0 z-40">
           ...
           <div className="flex items-center gap-6">
             ...
             <div className="relative" ref={dropdownRef}>
               ...
               >
                  <div className="text-right hidden sm:block text-nowrap overflow-hidden max-w-[150px]">
                     <p className="text-sm font-bold text-dark leading-none group-hover:text-primary transition-colors truncate">
        ...
        <main className="p-8 pb-16 animate-fade-in">
          <MembershipExpiryPopup
            ...
            membershipFee={parseFloat(initialSettings.membership_fee || '100')}
          />
          {children}
        </main>
      </div>
